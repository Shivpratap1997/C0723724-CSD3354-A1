...
namespace C0723724_CSD3354_A1
{
    class Shiv
    {
        public Shiv(string note, int dist)
        {
    ...
    class CountrySide
    {
        ...
        */
        ...
        public void TraverseVillages(Village CurrentVillage)
        {
            ...
            RorBahi.HugiJournal.Add(new Shiv(CurrentVillage.VillageName, CurrentVillage.distanceFromPreviousVillage));
            try
            {
        ...
        public void Announcement()
        {
            try
            {
                ...
                using (StreamReader sr = new StreamReader("U:/Users/723724/announcement.txt"))
                {
                    string line;
